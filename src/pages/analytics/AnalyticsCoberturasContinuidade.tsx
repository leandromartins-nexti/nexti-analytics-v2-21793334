...
export default function AnalyticsCoberturasContinuidade() {
    ...
    <div className="bg-[hsl(var(--surface))] min-h-screen flex flex-col">
      <header className="border-b border-border px-6 py-3 bg-[hsl(var(--surface))]">
        <div className="flex items-center gap-2 text-sm">
          ...
          <ChevronRight className="h-3.5 w-3.5 text-muted-foreground" />
          <span className="text-foreground font-semibold">Coberturas e Continuidade</span>
        </div>
      </header>
      ...
      <div className="px-6 py-6 flex-1">
        <p className="text-muted-foreground">Coberturas e Continuidade — em construção.</p>
      </div>
