...
interface EventosPostosDescobertosClienteDetailModalProps {
  isOpen: boolean;
  onClose: () => void;
  empresa: string;
  clientes: any[];
...
export function EventosPostosDescobertosClienteDetailModal({
  isOpen,
  onClose,
  empresa,
  clientes,
  onClienteClick,
}: EventosPostosDescobertosClienteDetailModalProps) {
  return (
